...
void update_valves(){
  ...
  delay(50);
  RS485Serial.print("valve ");
  RS485Serial.print(primaryValve.box);
  RS485Serial.print('#');
  RS485Serial.print(primaryValve.slot);
  RS485Serial.print(' ');
  RS485Serial.print(secondaryValve.box);
  RS485Serial.print('#');
  RS485Serial.print(secondaryValve.slot);
  RS485Serial.print("\r\n");
  RS485Serial.flush();
...
void setup() {
  ...
  RS485Serial.begin(RS485_BAUDRATE); // Start the software serial port
