...
// !!! this version is a hack needed, for an old circuit board - do not use for other stuff !!!
...
//                            A1 A2 A3 xx xx A6 A7 A8 xx B2 xx B4 xx xx xx B8 
int valvePins[VALVE_COUNT] = { 2, 3, 4,13,13, 7, 8, 9,13,12,13,A1,13,13,A4,13};
